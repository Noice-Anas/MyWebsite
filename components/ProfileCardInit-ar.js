/**
 * ProfileCard React Component Initialization - Arabic Version
...
// Initialize React and render ProfileCard (Arabic version)
    ...
    root.render(
      React.createElement(
        ...
        React.createElement(TextType, {
          text: ['مهندس برمجيات يطور نفسه يوميًا', 'بناء بغرض وهدف', 'التعلم في كل يوم'],
          as: 'h2',
        ...
        React.createElement(ProfileCard, {
          name: 'أنس الحلبي',
          title: 'مهندس برمجيات يطور نفسه يوميًا',
          handle: 'Noice-Anas',
          status: 'تواصل معي',
          avatarUrl: '/assets/anas_headshot.png',
          miniAvatarUrl: '/assets/anas_headshot.png',
